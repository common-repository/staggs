...
acf_add_local_field_group( array(
	...
	'fields' => array(
		...
		array(
			...
			'label' => 'Define your own configurator font',
			'name' => 'sgg_configurator_custom_font',
			'aria-label' => '',
			'type' => 'true_false',
			'instructions' => 'This setting overrides the default font settings defined in the Appearance page.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
		...
		array(
			'key' => 'field_64ce4042f7d84',
			'label' => 'Font Family',
			'name' => 'sgg_font_family',
			'aria-label' => '',
			'type' => 'text',
			'instructions' => 'If you need a custom font, you should enter the Font Family name here.',
			'required' => 0,
			'conditional_logic' => array(
				array(
					array(
